...
\useoutertheme{smoothbars} % tree shadow smoothtree smoothbars miniframes infolines split
...
\centerline{\resizebox{8cm}{!}{\includegraphics{images/BndEnv.pdf}}}
}
...
\frame
  {  
    \frametitle{Sampled-Data PWA Systems: A Time-Delay Approach}
\centerline{\resizebox{8cm}{!}{\includegraphics{images/SDHelExPWA.pdf}}}
...
\frame
  {  
  \frametitle{Sampled-Data PWA Systems: A Time-Delay Approach}
\centerline{\resizebox{8cm}{!}{\includegraphics{images/ConHeli.pdf}}}
...
\frame
  {  
  \frametitle{Sampled-Data PWA Systems: A Time-Delay Approach}
\centerline{\resizebox{8cm}{!}{\includegraphics{images/SDHeli.pdf}}}
...
\eeq
  ...
  {
    \frametitle{Extension of linear controllers to PWA controllers}
\centerline{\resizebox{9cm}{!}{\includegraphics{images/OpenTraj.pdf}}}
\centerline{Trajectories of the open loop system}  
  ...
  {
    \frametitle{Extension of linear controllers to PWA controllers}
\centerline{\resizebox{9cm}{!}{\includegraphics{images/LinTraj.pdf}}}
\centerline{Trajectories of the closed-loop system for the linear controller}
  ...
  {
    \frametitle{Extension of linear controllers to PWA controllers}
\centerline{\resizebox{9cm}{!}{\includegraphics{images/PWATraj.pdf}}}
...
\frame
  {
    \frametitle{Backstepping Controller Synthesis for PWP Systems: A Sum of Squares Approach}
PWP approximation:
\centerline{\resizebox{5cm}{!}{\includegraphics{images/f1app.pdf}}\resizebox{5cm}{!}{\includegraphics{images/f2app.pdf}}}
}
\frame
  {
    \frametitle{Backstepping Controller Synthesis for PWP Systems: A Sum of Squares Approach}
...
\centerline{\resizebox{8cm}{!}{\includegraphics{images/stpwa.pdf}}}    
}
...
\centerline{\resizebox{8cm}{!}{\includegraphics{images/inpwa.pdf}}}    
}
...
\centerline{\resizebox{8cm}{!}{\includegraphics{images/stpwp.pdf}}}    
}
...
\centerline{\resizebox{8cm}{!}{\includegraphics{images/inpwp.pdf}}}    
}
